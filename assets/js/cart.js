		...
		for(var i = lowerLimit; i <= upperLimit; i++){
			if((upperLimit < 8)){
				if(products[i].stock > 0){
					...
					content+= '</p>'
					content+= '<p class="trippy_btn-wrapper">'
					content+= '<a href="/activities/'+ products[i].prodType + '/' + products[i].urlName  +'"><button class="book_btn"><span class="trippy_btn-left"></span>Book Now<span class="trippy_btn-right"></span></button>'
					content+= '</a><br />'
					content+= '</p>'
					content+= '</div>'
					content+= '</div>'
			...
			// ParaGliding
			else if((upperLimit >= 8)&&(upperLimit<=9)){
				if(products[i].stock > 0){
					content+= '<div class="row row--padding-medium">'
					content+= '<div class="wrapper col-medium" data-aos="zoom-in" data-aos-easing="ease-in-out-quad">'
					content+= '<a href="/activities/paragliding/'+ products[i].urlName +'" class="wopper wopper--trek" style="display: flex; justify-content: center; background-size:cover; background-image: url(\'/'+products[i].img+'\')">'
					content+= '<span class="banner__overlay">'
					...
					// content+= '</div>'
					// content+= '<a class="wopper__info-price" href="/activities/trekking/'+ products[i].urlName +'"><span>₹ '+ products[i].price +' /-</span></a>'
					// content+= '<a class="wop/per__info-price" href="/activities/trekking/"><span></span></a>'
					// content+= '</div>'
					// content+= '</div>'
					content+= '</div>'
					content+= '<div class="col-medium wrapper-text-right" data-aos="fade-left" data-aos-easing="ease-in-out-quad">'
					...
					content+= '</p>'
					content+= '<p class="trippy_btn-wrapper">'
					content+= '<a href="/activities/paragliding/'+ products[i].urlName +'"><button class="book_btn"><span class="trippy_btn-left"></span>Book Now<span class="trippy_btn-right"></span></button>'
					content+= '</a><br />'
					content+= '</p>'
					content+= '</div>'
					content+= '</div>'
			...
			// PeakClimbing
			else if((upperLimit >= 62)&&(upperLimit<=71)){
				if(products[i].stock > 0){
			...
			// Treks
				...
				if(products[i].stock > 0){
					...
					content+= '</p>'
					content+= '<p class="trippy_btn-wrapper">'
					content+= '<a href="/activities/trekking/'+ products[i].urlName +'"><button class="book_btn"><span class="trippy_btn-left"></span>Book Now<span class="trippy_btn-right"></span></button>'
					content+= '</a><br />'
					content+= '</p>'
					content+= '</div>'
					content+= '</div>'
...
// 					content+= '</div>'
					...
					content+= '<div class="row row--padding-medium">'
					content+= '<div class="wrapper col-medium" data-aos="zoom-in" data-aos-easing="ease-in-out-quad">'
					content+= '<a href="/activities/camping/'+ products[i].urlName +'" class="wopper wopper--trek" style="display: flex; justify-content: center; background-size:cover; background-image: url(\'/'+products[i].img+'\')">'
					content+= '<span class="banner__overlay">'
					// content+= '<span class="trek-slide--price"><span style="font-size: 60%;">Starting From</span> <i class="fa fa-rupee-sign"></i> 2199/-</span>'
					content+= '<span class="trek-slide--price"'+ products[i].urlName +'">'+ products[i].days +' Days '+ products[i].nights +' Nights</span>'
					content+= '</span>'
					...
					content+= '</p>'
					content+= '<p class="trippy_btn-wrapper">'
					content+= '<a href="/activities/camping/'+ products[i].urlName +'"><button class="book_btn"><span class="trippy_btn-left"></span>Book Now<span class="trippy_btn-right"></span></button>'
					content+= '</a><br />'
					content+= '</p>'
					content+= '</div>'
					content+= '</div>'
			...
			// Escape Trips
			else if((upperLimit >= 45)&&(upperLimit<=51)){
				if(products[i].stock > 0){
			...
			// Bike-Tours
				...
				if(products[i].stock > 0){
					...
					// content+='</div>'
						...
						content+= '</p>'
						content+= '<p class="trippy_btn-wrapper">'
						content+= '<a href="/activities/bike-tours/'+ products[i].urlName +'"><button class="book_btn"><span class="trippy_btn-left"></span>Book Now<span class="trippy_btn-right"></span></button>'
						content+= '</a><br />'
						content+= '</p>'
						content+= '</div>'
						content+= '</div>'
			...
			// Mountain bike tours
			else if((upperLimit >= 60)&&(upperLimit<=61)){
				if(products[i].stock > 0){
					...
					content+= '</p>'
					content+= '<p class="trippy_btn-wrapper">'
					content+= '<a href="/activities/rock-climbing/'+ products[i].urlName +'"><button class="book_btn"><span class="trippy_btn-left"></span>Book Now<span class="trippy_btn-right"></span></button>'
					content+= '</a><br />'
					content+= '</p>'
					content+= '</div>'
					content+= '</div>'
